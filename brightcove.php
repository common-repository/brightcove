...
Plugin URL: http://wordpress.org/extend/plugins/brightcove-video-cloud
Description: This plugin has been deprecated. Please visit [http://wordpress.org/extend/plugins/brightcove-video-cloud/](Brightcove Video Cloud) to download the new version. Note that all of your shortcodes will still work as long as the same Publisher ID and API Read token are used. 
Author: Brightcove
Version: 1.0
Author URI: 
*/
